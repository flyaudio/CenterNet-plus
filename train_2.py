...
def parse_args():
    ...
    parser.add_argument('-d', '--dataset', default='fastprint',
                        help='voc or coco')
    ...
    parser.add_argument('-r', '--resume', type=str, default='weights/coco/centernet_plus/centernet_plus_32_0.17.pth',
                        help='keep training')
    ...
    parser.add_argument('--eval_epoch', type=int,
                            default=9991, help='interval between evaluations')
...
def train():
    ...
    if model_name == 'baseline':
        ...
        from models.centernet_plus_simple import CenterNetPlus as centernet
        cfg = train_cfg
    ...
    for epoch in range(args.start_epoch, max_epoch):
        ...
        for iter_i, (images, targets) in enumerate(dataloader):
            ...
            # forward and loss
            cls_loss, txty_loss = model(images, target=targets)
            ...
            if iter_i % 10 == 0:
                ...
                print('[Epoch %d/%d][Iter %d/%d][lr %.6f]'
                    '[Loss: cls %.2f || txty %.2f || size %d || time: %.2f]'
